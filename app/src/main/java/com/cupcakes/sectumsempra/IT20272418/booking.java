package com.cupcakes.sectumsempra.IT20272418;
...
import com.cupcakes.sectumsempra.IT20247218.credit;
import com.cupcakes.sectumsempra.R;
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 if(awesomeValidation.validate()) {
                    ...
                    if (selectedmethod == 1) {
                        Intent i1 = new Intent(getApplicationContext(), com.cupcakes.sectumsempra.IT20247218.cash.class);
